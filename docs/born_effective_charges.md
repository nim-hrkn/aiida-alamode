...
## 結果のまとめ（2026-09-23、mygarden 系 2 台の CPU と GPU で同一）

### Z*（SevenNet-Polar、PS-M checkpoint、ASR 強制後の対角成分 [e]）

| 物質 | 構造 | A / B サイト | O | 文献（DFT） | ASR 残差 |
|---|---|---|---|---|---|
| BaTiO₃ | 立方 Pm-3m | Ba 2.72 / Ti 7.72 | −2.15（⊥）/ −6.14（∥） | 2.75 / 7.16 / −2.11 / −5.69 | 0.01 |
| BaZrO₃ | 立方 | Ba 2.72 / Zr 5.68 | −1.98 / −4.44 | 2.7 / 6.1 / −2.0 / −4.8 | 0.01 |
| BaHfO₃ | 立方 | Ba 2.74 / Hf 5.42 | −1.99 / −4.19 | — | 0.01 |
...
### ε∞（AnisoNet、num_neighbors 固定、固有値）
...
| 立方 SrTiO₃ | 6.55 | 実験 5.2、DFT 6.6 |
| 単斜 ZrO₂ | 5.16 / 5.69 / 5.76 | 4.7〜5.2 |
| ルチル TiO₂ | 7.71 / 7.71 / 9.26 | 6.8 / 6.8 / 8.4 |

文献値に対して 1〜2 割の範囲、異方性の向きは再現。1 ジョブ 2.4〜2.9 秒で GPU は不要。

### BORNINFO を anphon に入れた効果（NONANALYTIC = 3、Ewald）

| 物質 | Γ 点の最高 LO [THz]（NA0 → NA3） | Γ 点のソフト TO | 備考 |
|---|---|---|---|
| 立方 BaTiO₃ | 13.5 → 19.7 | −6.96 ×3 → −6.96 ×2 + LO 4.89 | 強誘電不安定性はそのまま |
